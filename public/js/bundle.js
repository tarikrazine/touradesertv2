...
exports.showAlert = exports.hideElement = void 0;
...
const login = async (email, password) => {
  try {
    ...
    if (res.data.status === 'success') {
      ...
      (0, _alert.showAlert)('Your are log in with success!', 'success'); // Go to home page after 1500
    ...
    (0, _alert.showAlert)(err.response.data.message, 'error');
  }
};
...
const logout = async e => {
  try {
    ...
    (0, _alert.showAlert)('Error logging out! try again.', 'error');
  }
};

exports.logout = logout;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"profile-update.js":[function(require,module,exports) {
"use strict";
...
const profileUpdate = async data => {
  try {
    ...
    if (res.data.status === 'success') {
      (0, _alert.showAlert)('Your profile updated with success!', 'success');
    }
  } catch (err) {
    (0, _alert.showAlert)(err.response.data.message, 'error');
  }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"password-update.js":[function(require,module,exports) {
"use strict";
...
/* eslint-disable */
const passwordUpdate = async (curr, newPass, confirm) => {
  try {
    const res = await (0, _axios.default)({
      method: 'PATCH',
    ...
    if (res.data.status === 'success') {
      (0, _alert.showAlert)('Your password updated with success!', 'success');
    }
  } catch (err) {
    (0, _alert.showAlert)(err.response.data.message, 'error');
  }
...
/* eslint-disable */
const stripe = Stripe('pk_test_51H9c8NBfbiiusskymnxibHCv2tl1jkXSu8hiViXvkMh1U9kgpOZrv3uH17uK26z9pSbUisNb17aniiJX3GNUMPF800GIM6uMG9');

const bookTour = async tourID => {
  try {
    //Get checkout session from API
    const session = await (0, _axios.default)(`http://localhost:3000/api/v1/booking/checkout-session/${tourID}`); // Create checkout form + charge credit card

    await stripe.redirectToCheckout({
      sessionId: session.data.session.id
    });
  } catch (err) {
    (0, _alert.showAlert)(err, 'error');
  }
};
